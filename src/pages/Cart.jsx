...
// const Cart = () => {
//   //hamhe sirf initialState:[] ye jo slice ki initial state h wo chaihe lets agar value leni hoti to state.value karte
//   const {cart}=useSelector((state)=>state);
//   console.log("Cart ke andar h");
//   console.log(cart);
...
//         (<div className='flex flex-row max-w-[1200px] justify-center '>
...
//        <div>
//        <div>Your Cart</div>
//        <div className='text-2xl text-green-500 font-semibold uppercase'>Summary</div>
//        <p>
